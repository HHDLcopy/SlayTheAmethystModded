...
public final class ReflectionUtil {
    ...
    public static Class<?> forName(String fqcn) {
        ...
        ClassLoader gameCl = GameProbe.GAME_CLASSLOADER;
        if (gameCl != null) {
        ...
        java.lang.instrument.Instrumentation inst = GameProbe.getInstrumentation();
        if (inst != null) {
            ...
            for (Class<?> cls : inst.getAllLoadedClasses()) {
                if (isGameClass(cls.getName())) {
                    try {
                        ...
                        GameProbe.GAME_CLASSLOADER = cls.getClassLoader();
                        return found;
                    } catch (ClassNotFoundException ignored) {}
                    break;
                }
